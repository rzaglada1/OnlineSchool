...
public class LogToFile {
    ...
    private LogToFile() {
        ...
        pathLogFile = Path.of(MenuUtils.STR_PATH_DIRECTORY, MenuUtils.STR_NAME_LOG);
        pathServiceFile = Path.of(MenuUtils.STR_PATH_DIRECTORY, MenuUtils.STR_NAME_SERVICE);
    ...
    public LogLevel loadFromServiceFile(LogProperty logProperty, Path path) {
        ...
        try (BufferedReader reader = Files.newBufferedReader(path)) {
            ...
            System.out.println("File service " + '\"' + MenuUtils.STR_NAME_SERVICE + '\"'
