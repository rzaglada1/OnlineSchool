...
//        AddMaterialsService addMaterialsService = new AddMaterialsService(new AddMaterialsRepository());
//
...
//
//        addMaterialsService.getAllAddMaterials().add(addMaterials0);
//        addMaterialsService.getAllAddMaterials().add(addMaterials1);
//    }
//
//    @Test
//    void testGetAddMaterialsByLectureId () {
//        List<AddMaterials> actualList = new AddMaterialsService(addMaterialsService.getInstance()).getAddMaterialsByLectureId(1);
